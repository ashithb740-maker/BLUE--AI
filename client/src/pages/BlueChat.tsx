  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#08090d] text-white">
      ...
      <aside className={`${sidebarOpen ? "translate-x-0" : "-translate-x-full"} fixed inset-y-0 left-0 z-30 flex w-[280px] flex-col border-r border-white/[.08] bg-[#0b0d12]/95 p-3 backdrop-blur-xl transition-transform md:relative md:translate-x-0`}>
        ...
        <div className="mt-auto rounded-2xl border border-white/[.08] bg-white/[.025] p-4"><div className="flex items-center gap-2 text-xs font-medium text-white/65"><Sparkles className="size-3.5 text-cyan-300" /> Gemini-powered BLUE</div><p className="mt-2 text-[11px] leading-5 text-white/30">Your Gemini key stays on the server.</p></div>
      </aside>
