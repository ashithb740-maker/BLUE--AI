    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (response.status === 429) {
          ...
          setError(data?.error || "You've used today's 5,000 free BLUE tokens. Your free allowance resets at 12:00 AM IST. Upgrade to continue chatting now.");
