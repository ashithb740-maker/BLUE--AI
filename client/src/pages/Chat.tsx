...
type LocalMessage = { id?: number; role: "user" | "assistant" | "system"; content: string; attachments?: Attachment[]; createdAt?: Date | string };
...
export default function Chat() {
  ...
  const submit = (value?: string) => {
    ...
    setMessages(prev => [...prev, optimistic]); setInput(""); setIsGenerating(true); setIsNearBottom(true);
    sendMutation.mutate({ conversationId: selectedId ?? undefined, content: optimistic.content, mode, model, attachments }, {
      ...
      onError: error => { setIsGenerating(false); toast.error(error.message || "NOVA could not respond"); },
    });
  };
